...
BERT_PATH = ROOT2 / "bert-base-chinese"
DATA_DIR = ROOT1 / "data" / "peoples_daily"
CKPT_DIR = ROOT2 / "outputs" / "checkpoints"
LOG_DIR = ROOT2 / "outputs" / "logs"
...
def parse_args():
    ...
    parser.add_argument("--use_crf", default=True, action="store_false", help="使用 CRF 层（否则使用线性头）")
